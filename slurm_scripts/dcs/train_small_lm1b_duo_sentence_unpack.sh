#!/bin/bash
#SBATCH -J duo-lm1b-wrap-small              # Job name
#SBATCH -o watch_folder/dcs/duo_lm1b_wrap_small/%x_%j.out     # output file (%j expands to jobID)
...
# Since we have 4 * 64 < 512, gradient accummulation (of 2 steps) will happen.  
# Run up to 1M steps
